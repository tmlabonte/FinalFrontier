...
public class Location {
	...
	public void displayLocation(Panel terminal) {
		...
		terminal.write("Food: " + Player.currentShip().currentFood() + "/" + Player.currentShip().foodCapacity(), 20, 7);
		terminal.write("Fuel: " + Player.currentShip().currentFuel() + "/" + Player.currentShip().fuelCapacity(), 20, 8);
