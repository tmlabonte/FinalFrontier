...
public class CommodityGenerator {
	...
	//Returns an array of unique Commodities (all with quantity 1)
	public Commodity[] generateCommodities(int amount) {
		...
		String[] adj = {"Amazing", "Biological", "Crispy", "Dull", "Extreme", "Ferrous", "Gorgeous", "Horrible",
						"Illustrious", "Jazzy", "Keen", "Luscious", "Massive", "Nubile", "Organic",
		...
		String[] noun = {"Abacus", "Bearskin", "Candle", "Diary", "Eolith", "Forearm", "Gavel", "Hardware",
						 ...
						 "Parka", "Quiver", "Raspberry", "Saddle", "Tiara", "Ukulele", "Ventricle",
